...
public class DangNhap extends javax.swing.JFrame {
    ...
    public DangNhap() {
        ...
        txt_TaiKhoan.setToolTipText("Nhập số điện thoại");
        txt_MatKhau.setToolTipText("Nhập mật khẩu");
    ...
    private void thucHienDangNhap() {
        try {
            String soDienThoai = txt_TaiKhoan.getText().trim();
            ...
            if(soDienThoai.isEmpty() || matKhau.isEmpty()) {
                ...
                txt_BaoLoi.setForeground(Color.RED);
            ...
            if (!soDienThoai.matches("^(0|84)[1-9]\\d{8}$")) {
                txt_BaoLoi.setText("Số điện thoại không hợp lệ!");
                txt_BaoLoi.setForeground(Color.RED);
                txt_TaiKhoan.setEnabled(true);
                txt_TaiKhoan.requestFocus();
            ...
            NhanVienEntity nhanVien = nvDao.dangNhap(soDienThoai, matKhau);
            
            if (nhanVien == null) {
                txt_BaoLoi.setText("Sai thông tin đăng nhập!");
                txt_BaoLoi.setForeground(Color.RED);
                txt_TaiKhoan.setEnabled(true);
                txt_MatKhau.setEnabled(true);
                txt_MatKhau.setText("");
